                ...
                <div class="widget-carousel owl-carousel owl-theme">
                    <div class="blog-item">
                        <div class="item-media">
                            ...
                            <div class="media-photo">
                                <a href="blog-single.html" data-background="{{ asset('img/photo-blog-1.jpg') }}"></a>    
                            </div>
                        </div>
                        <div class="item-desc">
                    ...
                    <div class="blog-item">
                        <div class="item-media">
                            ...
                            <div class="media-photo">
                                <a href="blog-single.html" data-background="{{ asset('img/photo-blog-2.jpg') }}"></a>    
                            </div>
                        </div>
                        <div class="item-desc">
                    ...
                    <div class="blog-item">
                        <div class="item-media">
                            ...
                            <div class="media-photo">
                                <a href="blog-single.html" data-background="{{ asset('img/photo-blog-3.jpg') }}"></a>    
                            </div>
                        </div>
                        <div class="item-desc">
                        ...
                        <div class="item-media">
                            ...
                            <div class="media-gallery">
                                <div class="media-carousel owl-carousel owl-theme owl-type1">
                                    <a href="blog-single-gallery.html" data-background="{{ asset('img/photo-blog-4.jpg') }}"></a>
                                    <a href="blog-single-gallery.html" data-background="{{ asset('img/photo-blog-1.jpg') }}"></a>
                                    <a href="blog-single-gallery.html" data-background="{{ asset('img/photo-blog-2.jpg') }}"></a>
                                </div>
                            </div>
                        </div>
                        <div class="item-desc">
