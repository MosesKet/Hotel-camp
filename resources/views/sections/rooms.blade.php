            ...
            <div class="wrapper-inner">
                ...
                <div class="widget-carousel owl-carousel owl-theme">
                    <div class="rooms-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="rooms-detail.html" data-background="{{ asset('img/photo-room-1.jpg') }}"></a>
                            </div>
                            <div class="item-desc">
                    ...
                    <div class="rooms-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="rooms-detail.html" data-background="{{ asset('img/photo-room-2.jpg') }}"></a>
                            </div>
                            <div class="item-desc">
                    ...
                    <div class="rooms-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="rooms-detail.html" data-background="{{ asset('img/photo-room-3.jpg') }}"></a>
                            </div>
                            <div class="item-desc">
                    ...
                    <div class="rooms-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="rooms-detail.html" data-background="{{ asset('img/photo-room-4.jpg') }}"></a>
                            </div>
                            <div class="item-desc">
