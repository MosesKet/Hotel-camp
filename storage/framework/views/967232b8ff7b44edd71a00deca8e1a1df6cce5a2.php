                        ...
                        <div class="col-md-8">
                            ...
                            <div class="room-slider">
                                ...
                                <div class="owl-carousel owl-theme owl-type1">
                                    <a href="<?php echo e(asset('img\photo-room-detail-5.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-5.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-4.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-4.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-3.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-3.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-2.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-2.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-1.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-1.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-5.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-5.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-4.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-4.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-3.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-3.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                                    <a href="<?php echo e(asset('img\photo-room-detail-2.jpeg')); ?>" data-background="<?php echo e(asset('img/photo-room-detail-2.jpg')); ?>" title="Single Room" class="popup-gallery"></a>
                            ...
                            <div class="room-thumbnails">
                                <div class="owl-carousel">
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-5.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-4.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-3.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-2.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-1.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-5.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-4.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-3.jpg')); ?>" title="Single Room"></a>
                                    <a href="#" data-background="<?php echo e(asset('img/photo-room-detail-2.jpg')); ?>" title="Single Room"></a>
...
<?php /**PATH C:\xampp\htdocs\camp-link.com\resources\views/sections/room-details.blade.php ENDPATH**/ ?>