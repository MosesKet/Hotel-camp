    <!-- Section Offers -->
    <div class="section">
        <div class="widget-offers-grid" data-background="<?php echo e(asset('img/photo-offers.jpg')); ?>">
                ...
                <div class="widget-inner">
                    <div class="offers-item">
                        <div class="item-inner">
                            <div class="item-photo" data-background="<?php echo e(asset('img/photo-offers-1.jpg')); ?>"></div>
                            <div class="item-desc">
                    ...
                    <div class="offers-item">
                        <div class="item-inner">
                            <div class="item-photo" data-background="<?php echo e(asset('img/photo-offers-2.jpg')); ?>"></div>
                            <div class="item-desc">
                    ...
                    <div class="offers-item">
                        <div class="item-inner">
                            <div class="item-photo" data-background="<?php echo e(asset('img/photo-offers-3.jpg')); ?>"></div>
                            <div class="item-desc">
                    ...
                    <div class="offers-item">
                        <div class="item-inner">
                            <div class="item-photo" data-background="<?php echo e(asset('img/photo-offers-4.jpg')); ?>"></div>
                            <div class="item-desc">
    ...
    <!-- Section Offers End -->
<?php /**PATH C:\xampp\htdocs\camp-link.com\resources\views/sections/offers.blade.php ENDPATH**/ ?>