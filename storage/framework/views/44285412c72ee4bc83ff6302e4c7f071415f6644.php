        ...
        <div class="widget-slider">
            <div class="wrapper-full">
                ...
                <div class="widget-carousel owl-carousel owl-theme">
                    <div class="slider-item" data-background="<?php echo e(asset('img/photo-slide-1.jpg')); ?>">
                        <div class="wrapper">
                    ...
                    <div class="slider-item" data-background="<?php echo e(asset('img/photo-slide-2.jpg')); ?>">
                        <div class="wrapper">
                            <div class="item-inner">
                                <h5>WELCOME TO THE GRANDIUM</h5>
                    ...
                    <div class="slider-item" data-background="<?php echo e(asset('img/photo-slide-3.jpg')); ?>">
                        <div class="wrapper">
                            <div class="item-inner">
                                <h5>WELCOME TO THE GRANDIUM</h5>
                                <h1>Touch The Sea</h1>
    ...
    <!-- Section Slider End -->
<?php /**PATH C:\xampp\htdocs\camp-link.com\resources\views/sections/slider.blade.php ENDPATH**/ ?>