            ...
            <div class="wrapper-inner">
                ...
                <div class="widget-carousel owl-carousel owl-theme">
                    <div class="team-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="#" data-background="<?php echo e(asset('img/user-1.jpg')); ?>"></a>
                            </div>
                            <div class="item-desc">
                    ...
                    <div class="team-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="#" data-background="<?php echo e(asset('img/user-2.jpg')); ?>"></a>
                            </div>
                            <div class="item-desc">
                                <h3>JACK MASON</h3>
                    ...
                    <div class="team-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="#" data-background="<?php echo e(asset('img/user-3.jpg')); ?>"></a>
                            </div>
                            <div class="item-desc">
                    ...
                    <div class="team-item">
                        <div class="item-inner">
                            <div class="item-photo">
                                <a href="#" data-background="<?php echo e(asset('img/user-4.jpg')); ?>"></a>
                            </div>
                            <div class="item-desc">
                                <h3>JOHN FEDERICO</h3>
    ...
    <!-- Section Team End -->
<?php /**PATH C:\xampp\htdocs\camp-link.com\resources\views/sections/team.blade.php ENDPATH**/ ?>